...
1.Используйте модель SSD и сравните полученные результаты.
...
$Score_{3}$ – тест по второму модулю. Принимает значение от 0 до 10. Тест проводится в форме тестирования и состоит из 20 вопросов: 10 вопросов по теории и 10 вычислительных. Число баллов зависит от числа правильных ответов. За каждый вопрос при полностью правильном ответе можно получить 0.5 балла.
