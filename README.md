...
Напомню, сдавать на почту можно отчёты только по 1, 3, 4 и 6 семинарам. Отчёт в ipynb, можно на colab, в отчёте помимо кода с комментариями необходимы описание датасета, пояснения к действиям, выводы.

Почта: aaprovorova@hse.ru

Срок сдачи на почту: не позднее 16 октября 2023.

Последняя пара пройдёт 17 октября 2023, в этот день будут выставлены оценки за практику.
